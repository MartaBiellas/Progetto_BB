...
<body>
	...
	<div class="header">
		...
		<table id="tab_dati_personali">
				...
				<tr>	
					<td><div class="input-group"><label> Materia </label></div></td>
					<td><div class="input-group"><input type="text" name="materia" value="<?php echo $row["materia"]; ?>" <?php if(!$modifica) echo "disabled='disabled'"?>></div></td>
				</tr>
			</table>
